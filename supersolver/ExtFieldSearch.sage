    ...
    if supersolver:
        ...
        while ell < mod_poly_max-1:
            ...
            if muls_ell < (N_ell*muls_step):
                ...
                neighbours_ells.append(N_ell)
                print("Rapid inspection of ", N_ell, " nodes in the ", ell, "-isogeny graph takes at most ", round(muls_ell/N_ell,2), "Fp-multiplications per node")   
